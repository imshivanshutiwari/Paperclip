...
export const help: Record<string, string> = {
  ...
  maxTurnsPerRun: "Maximum number of agentic turns (tool calls) per pulse run.",
  ...
  intervalSec: "Seconds between automatic pulse invocations.",
  ...
  cooldownSec: "Minimum seconds between consecutive pulse runs.",
  maxConcurrentRuns: "Maximum number of pulse runs that can execute simultaneously for this agent.",
